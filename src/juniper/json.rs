...
fn build_field<'r, 't, S, T>(info: &SchemaInfo, registry: &mut Registry<'r, S>, field_name: &str, type_ref: Type<'t, T>, nullable: bool) -> Field<'r, S>
            ...
            Some(field_value) => {
                match field_value {
                    ...
                    JsonValue::Object(field_value) => {
                        ...
                        executor.resolve::<Object>(&SchemaInfo {
                            schema: "".to_string(),
